 ...
 * Detail:仿ios时间选择框
 */
class OptionsPickerBuilder(context: Context) {
    //配置类
    ...
    //Required
    fun setOnOptionsSelectListener(listener: OnOptionsSelectListener): OptionsPickerBuilder {
     ...
     */
    fun setDividerColor(dividerColor: Int): OptionsPickerBuilder {
     ...
     */
    fun setTextColorOut(textColorOut: Int): OptionsPickerBuilder {
